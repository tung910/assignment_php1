...
$datas = mysqli_query($conn, "SELECT * FROM san_pham WHERE `ma_ploai` = 'Điện thoại'");
// var_dump($data);die;
?>
...
<section class="product" id="product">
    ...
    <h1 class="heading">Tất cả <span>điện thoại</span></h1>
        ...
        while ($row = mysqli_fetch_array($datas)) { ?>
            <div class="box">
                ...
                <div class="quantity">
                    ...
                    <input type="submit" class="btn" name="mua" style="color: white;" value="Mua ngay">
