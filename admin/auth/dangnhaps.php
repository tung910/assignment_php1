        ...
        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h2 class="text-center" style="color: red;"> <?php
                ...
                <div class="panel-body">
                    ...
                    <button name="btn" class="btn btn-success"><a style="text-decoration: none; color: white;" href="http://localhost/web_ban_hang/admin/auth/login_form.php">Đăng kí</a></button>
                </div>
            </div>
        </div>
    </form>
