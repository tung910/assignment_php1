...
<section class="contact" id="contact">
	...
	<form action="./category/lien_he.php" method="POST">
		<h2 style="text-align: center; color: green;"> <?php

														if (isset($_SESSION['lh_tc'])) {

															echo $_SESSION['lh_tc'];
															unset($_SESSION['lh_tc']);
														} ?></h2>
			<h2 style="text-align: center; color: red;"> <?php

															if (isset($_SESSION['lh_ktc'])) {
																echo $_SESSION['lh_ktc'];
																unset($_SESSION['lh_ktc']);
															}
															?>
			</h2>
			<div class="inputBox">
...
<div class="row w3l-grids-footer border-top border-bottom py-sm-4 py-3" style="width: 1000px; margin: 0 auto;">
